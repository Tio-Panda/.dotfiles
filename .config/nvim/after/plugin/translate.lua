...
-- Window
--==================
map("n", "<leader>tt", "viw:Translate en -source=es<CR>", "[t]ranslate current word ES->EN")
map("n", "<leader>TT", "viw:Translate es -source=en<CR>", "[T]ranslate current word EN->ES")
