...
-- local ranHeader = function(t)
--     return t[1]
--     -- return t[math.random(#t)]
-- end

-- TODO: Se cambian cada vez que se refresca la pag, hacer que se haga cada vez que inicia el dashboard
local randomHeader = function()
    local headerVerify = math.random(#headers)
    -- vim.api.nvim_create_autocmd({ "User" }, {
    --     pattern = { "AlphaReady" },
    --     callback = function(_)
    --         headerVerify = math.random(#headers)
    --     end,
    -- })
    return headers[headerVerify]
end
